...
CCFLAGS += $(foreach HEADER_SEARCH_PATH,$(HEADER_SEARCH_PATHS),-I$(HEADER_SEARCH_PATH))

CCFLAGS += -I$(DERIVED_SOURCES_NORMAL)/$(ARCHS)
CCFLAGS += -I$(DERIVED_SOURCES)/$(ARCHS)
CCFLAGS += -I$(DERIVED_SOURCES)
